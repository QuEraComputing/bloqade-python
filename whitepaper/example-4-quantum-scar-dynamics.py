...
rabi_adiabatic_prep = (
    ...
    .append(Constant(value=15.7, duration=1.6))
    .append(Linear(start=15.7, stop=0.0, duration=0.3))
)

rabi_scar_dynamics = (
    Linear(start=0.0, stop=15.7, duration=0.2)
    .append(Constant(value=15.7, duration=1.8))
    .append(Linear(start=15.7, stop=0.0, duration=0.2))
)
...
detuning_adiabatic_prep = (
    ...
    .append(Linear(start=-18.8, stop=16.3, duration=1.6))
    .append(Constant(value=16.3, duration=0.3))
)

detuning_scar_dynamics = Linear(start=16.3, stop=0.0, duration=0.2).append(
...
quantum_scar_program = (
    start.add_positions([(0.0, atom_spacing * i) for i in range(11)])
    .rydberg.rabi.amplitude.uniform.apply(rabi_wf[:"run_time"])
    .detuning.uniform.apply(detuning_wf[:"run_time"])
...
quantum_scar_job = quantum_scar_program.batch_assign(
    run_time=run_times
