...
from bloqade.core.compiler.passes.hardware.components import AHSComponents
from bloqade.core.ir import analog_circuit
from bloqade.core.ir.control import pulse, sequence, field

from bloqade.core.submission.ir.braket import BraketTaskSpecification

from bloqade.core.submission.ir.capabilities import QuEraCapabilities
from bloqade.core.submission.ir.task_specification import QuEraTaskSpecification
...
def analyze_channels(circuit: analog_circuit.AnalogCircuit) -> Dict:
    ...
    * there is no more than one non-uniform spatial modulation for detuning
    ...
    """
    from bloqade.core.compiler.analysis.hardware import ValidateChannels
    from bloqade.core.compiler.analysis.common import ScanChannels
...
def add_padding(
    ...
    """
    from bloqade.core.compiler.rewrite.common import AddPadding
...
def assign_circuit(
    ...
    """
    from bloqade.core.compiler.analysis.common import AssignmentScan, ScanVariables
    from bloqade.core.compiler.rewrite.common import AssignBloqadeIR
...
def validate_waveforms(
    ...
    """
    from bloqade.core.compiler.analysis.hardware import (
        ValidatePiecewiseConstantChannel,
        ValidatePiecewiseLinearChannel,
    )
    from bloqade.core.compiler.analysis.common import CheckSlices
...
def to_literal_and_canonicalize(
    ...
    """
    from bloqade.core.compiler.rewrite.common import (
        AssignToLiteral,
        Canonicalizer,
        FlattenCircuit,
    )
...
def generate_ahs_code(
    ...
    """
    from bloqade.core.compiler.codegen.hardware import (
        GenerateLattice,
...
def generate_quera_ir(
    ...
    from bloqade.core.compiler.passes.hardware.units import (
        convert_time_units,
