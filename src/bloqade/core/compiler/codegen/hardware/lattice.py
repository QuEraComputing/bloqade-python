from bloqade.core.ir.location import location
from bloqade.core.ir import analog_circuit
from bloqade.core.submission.ir.parallel import ClusterLocationInfo, ParallelDecoder
from bloqade.core.submission.capabilities import QuEraCapabilities
...
class GenerateLattice(BloqadeIRVisitor):
    ...
    def visit_location_ParallelRegister(self, node: location.ParallelRegister):
        from bloqade.core.ir.location.location import ParallelRegisterInfo
