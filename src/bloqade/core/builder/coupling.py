...
from bloqade.core.builder.field import Rabi, Detuning
...
class LevelCoupling(Builder):
    ...
    def detuning(
        ...
        """
        Specify the [`Detuning`][bloqade.core.builder.field.Detuning]
         [`Field`][bloqade.core.builder.Field] of your program.
    ...
    def rabi(self) -> Rabi:
        """
        Specify the complex-valued [`Rabi`][bloqade.core.builder.field.Rabi]
        ...
        - Next possible steps to build your program are
          creating the [`RabiAmplitude`][bloqade.core.builder.field.RabiAmplitude]
          field
          and [`RabiPhase`][bloqade.core.builder.field.RabiAmplitude] field of the
          field:
...
class Rydberg(LevelCoupling):
    ...
    Examples:
        ...
        >>> type(node)
        <class 'bloqade.core.builder.coupling.Rydberg'>

        - Rydberg level coupling have two reachable field nodes:

            - detuning term (See also [`Detuning`][bloqade.core.builder.field.Detuning])
            - rabi term (See also [`Rabi`][bloqade.core.builder.field.Rabi])
    ...
    def __bloqade_ir__(self):
        from bloqade.core.ir.control.sequence import rydberg
...
class Hyperfine(LevelCoupling):
    ...
    Examples:
        ...
        >>> type(node)
        <class 'bloqade.core.builder.coupling.Hyperfine'>
    ...
    def __bloqade_ir__(self):
        from bloqade.core.ir.control.sequence import hyperfine
