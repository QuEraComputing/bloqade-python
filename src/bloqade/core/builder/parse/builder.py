...
from bloqade.core.builder.coupling import LevelCoupling, Rydberg, Hyperfine
from bloqade.core.builder.sequence_builder import SequenceBuilder
from bloqade.core.builder.field import Field, Detuning, RabiAmplitude, RabiPhase
from bloqade.core.builder.spatial import SpatialModulation, Location, Uniform, Scale
from bloqade.core.builder.waveform import WaveformPrimitive, Slice, Record, Sample, Fn
from bloqade.core.builder.assign import Assign, BatchAssign, ListAssign
from bloqade.core.builder.args import Args
from bloqade.core.builder.parallelize import Parallelize
from bloqade.core.builder.parse.stream import BuilderNode, BuilderStream
import bloqade.core.ir as ir
from beartype.typing import TYPE_CHECKING, Tuple, Union, Dict, List, Optional, Set

if TYPE_CHECKING:
    from bloqade.core.ir.routine.params import ParamType
...
class Parser:
    ...
    def parse(self, builder: Builder) -> "Routine":
        from bloqade.core.ir.analog_circuit import AnalogCircuit
        from bloqade.core.ir.routine.params import Params, ScalarArg, VectorArg
        from bloqade.core.ir.routine.base import Routine
        from bloqade.core.compiler.analysis.common.scan_variables import ScanVariables
