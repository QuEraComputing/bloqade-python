...
from bloqade.core.builder.typing import ScalarType, LiteralType
from bloqade.core.builder.waveform import WaveformAttachable
from bloqade.core.builder.base import Builder


if TYPE_CHECKING:
    from bloqade.core.ir.control.field import (
        UniformModulation,
        ScaledLocations,
...
class Uniform(SpatialModulation):
    ...
    (See [`Waveform`][bloqade.core.builder.waveform] for available waveform options)
    ...
    Examples:
        ...
        >>> wv = bloqade.core.ir.Linear(start=0,stop=1,duration=0.5)
        >>> reg = bloqade.start.add_position([(0,0),(1,1),(2,2),(3,3)])
    ...
    def __bloqade_ir__(self) -> "UniformModulation":
        from bloqade.core.ir import Uniform
...
class Location(SpatialModulation):
    ...
    def __init__(
        ...
        from bloqade.core.ir.scalar import cast
    ...
    def __bloqade_ir__(self) -> "ScaledLocations":
        from bloqade.core.ir import ScaledLocations
...
class Scale(SpatialModulation):
    ...
    def __bloqade_ir__(self) -> Union["RunTimeVector", "AssignedRunTimeVector"]:
        from bloqade.core.ir import RunTimeVector, AssignedRunTimeVector
