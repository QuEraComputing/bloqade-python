...
from bloqade.core.builder.typing import LiteralType, ParamType
from bloqade.core.ir.scalar import Variable
...
class Assignable:
    def assign(self, **assignments) -> "Assign":
        ...
        """
        from bloqade.core.builder.assign import Assign
...
class BatchAssignable:
    def batch_assign(
        ...
        **assignments: List[ParamType],
        ...
        """
        from bloqade.core.builder.assign import BatchAssign, ListAssign
