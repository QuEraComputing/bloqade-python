...
if TYPE_CHECKING:
    from bloqade.core.builder.spatial import Uniform, Location, Scale
...
class Field(Builder):
    ...
    def uniform(self) -> "Uniform":
        ...
        - You can now do:
            ...
            - `...uniform.poly([coefficients], duration)` : to apply a
                polynomial waveform
            - `...uniform.apply(wf:bloqade.core.ir.Waveform)`: to apply a
        ...
        """
        from bloqade.core.builder.spatial import Uniform

        return Uniform(self)

    @plum.dispatch
    def _location(self, label: int, scale: Optional[ScalarType] = None):  # noqa: F811
        from bloqade.core.builder.spatial import Location
    ...
    def location(
        ...
        - You can now do:
            ...
            - `...location(labels, scales).apply(wf:bloqade.core.ir.Waveform)`: to apply
    ...
    def scale(self, coeffs: Union[str, List[ScalarType]]) -> "Scale":
        ...
        - You can now do:
            ...
            - `...scale(coeffs).poly([coefficients], duration)` : to apply
                a polynomial waveform
            - `...scale(coeffs).apply(wf:bloqade.core.ir.Waveform)`: to apply
                a pre-defined waveform
        ...
        """
        from bloqade.core.builder.spatial import Scale
...
class Detuning(Field):
    ...
    Examples:
        ...
        >>> type(node)
        <class 'bloqade.core.builder.field.Detuning'>
    ...
    Note:
        ...
        See [`SpatialModulation`][bloqade.core.builder.field.SpatialModulation]
        for additional options.

    """

    def __bloqade_ir__(self):
        from bloqade.core.ir.control.pulse import detuning
...
class Rabi(Builder):
    ...
    Examples:
        ...
        <class 'bloqade.core.builder.field.Rabi'>
...
class RabiAmplitude(Field):
    ...
    Examples:
        ...
        >>> type(node)
        <class 'bloqade.core.builder.field.Amplitude'>
    ...
    def __bloqade_ir__(self):
        from bloqade.core.ir.control.pulse import rabi
...
class RabiPhase(Field):
    ...
    Examples:
        ...
        >>> type(node)
        <class 'bloqade.core.builder.field.Phase'>
