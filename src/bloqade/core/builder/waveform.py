...
from bloqade.core.builder.route import WaveformRoute
...
class WaveformAttachable(Builder):
    ...
    def linear(
        ...
        - Continue building your waveform via:
            ...
            - `...linear(start, stop, duration).apply(wf:bloqade.core.ir.Waveform)`:
    ...
    def constant(self, value: ScalarType, duration: ScalarType) -> "Constant":
        ...
        - Continue building your waveform via:
            ...
            - `...constant(value, duration).poly([coefficients], duration)`:
                to append a polynomial waveform
            - `...constant(value, duration).apply(wf:bloqade.core.ir.Waveform)`:
                to append a pre-defined waveform
    ...
    def apply(self, wf: ir.Waveform) -> "Apply":
        """
        Apply a [`Waveform`][bloqade.core.ir.control.Waveform] built previously to
        current location(s).
    ...
    def slice(
        ...
        - Continue building your waveform via:
            ...
            - `...slice(start, stop).poly([coefficients], duration)`:
                to append a polynomial waveform
            - `...slice(start, stop).apply(wf:bloqade.core.ir.Waveform)`:
                to append a pre-defined waveform
