...
from bloqade.core.ir.location.location import AtomArrangement, LocationInfo
from bloqade.core.ir import Literal, Scalar, cast
...
class BoundedBravais(AtomArrangement):
    ...
    - [`Square`][bloqade.core.ir.location.bravais.Square]
    - [`Chain`][bloqade.core.ir.location.bravais.Chain]
    - [`Honeycomb`][bloqade.core.ir.location.bravais.Honeycomb]
    - [`Triangular`][bloqade.core.ir.location.bravais.Triangular]
