...
from bloqade.core.builder.start import ProgramStart
from bloqade.core.ir.scalar import Scalar, Literal, cast
...
class ParallelRegister(ProgramStart):
    ...
    def _compile_to_list(
        ...
        from bloqade.core.compiler.codegen.hardware import GenerateLattice
