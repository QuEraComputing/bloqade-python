...
from bloqade.core.ir.scalar import (
    Scalar,
    Interval,
    Variable,
    AssignedVariable,
...
from bloqade.core.ir.control.traits import (
    HashTrait,
    AppendTrait,
    SliceTrait,
    CanonicalizeTrait,
...
class Waveform(HashTrait, CanonicalizeTrait):
    ...
    - [`<instruction>`][bloqade.core.ir.control.waveform.Instruction]
    - [`<smooth>`][bloqade.core.ir.control.waveform.Smooth]
    - [`<slice>`][bloqade.core.ir.control.waveform.Slice]
    - [`<apppend>`][bloqade.core.ir.control.waveform.Append]
    - [`<negative>`][bloqade.core.ir.control.waveform.Negative]
    - [`<scale>`][bloqade.core.ir.control.waveform.Scale]
    - [`<add>`][bloqade.core.ir.control.waveform.Add]
    - [`<record>`][bloqade.core.ir.control.waveform.Record]
    - [`<sample>`][bloqade.core.ir.control.waveform.Sample]
    ...
    def _get_data(self, npoints, **assignments):
        from bloqade.core.compiler.analysis.common.assignment_scan import (
            AssignmentScan,
        )
...
class Instruction(Waveform):
    ...
    - [`<linear>`][bloqade.core.ir.control.waveform.Linear]
    - [`<constant>`][bloqade.core.ir.control.waveform.Constant]
    - [`<poly>`][bloqade.core.ir.control.waveform.Poly]
    - [`<python-fn>`][bloqade.core.ir.control.waveform.PythonFn]
