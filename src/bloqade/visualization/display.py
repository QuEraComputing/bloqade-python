...
def display_ir(obj, assignments):
    ...
    from bloqade._core.ir.control.pulse import PulseExpr
    from bloqade._core.ir.control.sequence import SequenceExpr
    from bloqade._core.ir.control.field import Field, SpatialModulation
    from bloqade._core.ir.control.waveform import Waveform
    from bloqade._core.ir.location import AtomArrangement
