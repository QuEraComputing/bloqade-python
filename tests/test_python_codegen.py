import inspect
from bloqade.core.compiler.analysis.python.waveform import WaveformScan
from bloqade.core.compiler.rewrite.python.waveform import NormalizeWaveformPython
from bloqade.core.compiler.codegen.python.waveform import CodegenPythonWaveform
from bloqade.core.compiler.rewrite.common.assign_variables import AssignBloqadeIR
from bloqade.factory import piecewise_linear, piecewise_constant
import bloqade.core.ir.control.waveform as wf
...
@patch("bloqade.core.compiler.codegen.python.waveform.randint")
