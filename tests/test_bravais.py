from bloqade.core.ir.location.bravais import (
    Lieb,
    Square,
    Rectangular,
    Honeycomb,
...
from bloqade.core.ir.location.bravais import Cell
from bloqade import cast
from math import sqrt
from bloqade.core.compiler.codegen.common.json import BloqadeIRSerializer
