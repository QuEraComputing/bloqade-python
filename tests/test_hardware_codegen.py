...
from bloqade._core.ir import location, cast, Interpolation
from bloqade._core.ir import Constant, Linear, Poly, PythonFn, Sample
import pytest
import json
import numpy as np
...
def test_integration_scale():
    ...
    task_data = panel["bloqade._core.task.batch.RemoteBatch"]["tasks"][0][1]

    ir = task_data["bloqade._core.task.quera.QuEraTask"]["task_ir"]
